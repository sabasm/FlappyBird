...
function start(){
    ...
    audioback = new Audio("http://freesound.org/data/previews/343/343835_2822775-lq.mp3")
    audioback.play();
}
function update(){
    frames++
    ...
    if(audioback.currentTime===audioback.duration-1)audioback.play()
}
function gameOver(){
   audioback.pause();
   audioback.currentTime = 0;
    clearInterval(interval)
    var audio = new Audio('http://freesound.org/data/previews/415/415215_7062176-lq.mp3');
audio.play();
var audio2 = new Audio ("http://freesound.org/data/previews/202/202305_3184722-lq.mp3")
audio2.play();    
interval = null
    ctx.fillStyle = "red"
